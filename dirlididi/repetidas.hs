-- Crie um programa que, a partir de uma lista de palavras, retorna uma lista de tuplas do tipo (palavra, quantidade), onde "palavra" é uma palavra da lista e "quantidade" é o seu número de repetições dessa palavra na lista. Deve ser preservada a ordem das palavras na lista original
main = do
    entrada <- getLine
